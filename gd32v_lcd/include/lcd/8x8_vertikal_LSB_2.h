...
// The characters are stored in a way that is easy for the OLED display/library to display: 
// one byte means one column, 
// with the LSB on top and the MSB on the bottom. 
 
// V0.1
 
// A very basic font; the Scale2x algorithm shall be used to enlarge and improve it. 

#ifndef __8x8_VERTIKAL_H
#define __8x8_VERTIKAL_H 	   
